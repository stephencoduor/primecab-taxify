                ...
                <div class="row g-sm-4 g-3">
                    <div class="col-xxl-7 col-xl-8">
                        <form action="{{ route('admin.send-notification') }}" id="sendNotificationForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="col-md-2" for="image_id">{{ __('taxido::static.push_notification.image') }}</label>
                                <div class="col-md-10">
                                    <x-image :name="'image_id'" :data="isset($pushNotification->image) ? $pushNotification->image : old('image_id')" :text="__('taxido::static.push_notification.recommended')" :multiple="false"></x-image>
                                </div>
                            </div>
