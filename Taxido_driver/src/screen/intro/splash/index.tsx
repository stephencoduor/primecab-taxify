...
import { selfDriverData, settingDataGet, translateDataGet, taxidosettingDataGet, currentZone } from "../../../api/store/action";
import { useDispatch, useSelector } from "react-redux";
import { useAppNavigation } from "../../../utils/navigation";
import DeviceInfo from "react-native-device-info";
import useSmartLocation from "../../../commonComponents/helper/locationHelper";
import store from "../../../api/store";
import { requestLocationPermission } from "../../../commonComponents/helper/permissionHelper";
    ...
    try {
      ...
      const waitForZone = async () => {
        ...
        while (retries < maxRetries) {
          ...
          latestZone = state.zoneUpdate.zoneValue;
