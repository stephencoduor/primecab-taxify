...
export function BalanceTopup({ balance }: BalanceTopupProps) {
    ...
    return (
        <View style={styles.mainBalance}>
                ...
                <View style={{ marginHorizontal: windowWidth(18) }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        <TouchableOpacity activeOpacity={0.9} onPress={gotoTopUp} style={{ backgroundColor: appColors.whiteColor, height: windowHeight(28), width: '47.5%', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderRadius: windowHeight(5) }}>
                            <TopUp />
                            <Text style={{ color: appColors.primary, marginHorizontal: windowWidth(8), fontFamily: appFonts.medium }}>{translateData.topUp}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            activeOpacity={0.9}
                            style={{
            ...
            <Text style={{ color: '#B7C7C4', fontFamily: appFonts.regular, fontSize: fontSizes.FONT19, textAlign: 'center', marginTop: windowHeight(6.5) }}>{translateData.balanceasof} {formattedDate} </Text>
        </View>
    )
}